"""Add allow_others_to_view to CourseAssignmentSubmission

Revision ID: 69e65fe4b5fa
Revises: e1130138e6e5
Create Date: 2026-01-10 16:45:58.526797
...
def upgrade():
    ...
    with op.batch_alter_table('course_assignment_submission', schema=None) as batch_op:
        batch_op.add_column(sa.Column('allow_others_to_view', sa.Boolean(), nullable=True))
